...
####################title###########
        ...
        txt_sup=Entry(product_frame,textvariable=self.var_name,font=("goudy old style",15,),bg="lightyellow").place(x=150,y=160,width=200)
        ...
        try:
            if self.var_pid.get()=="" :
                ...
                if row==None:
                    ...
                    if op==True:
                        cur.execute("delete from product where eid=?",(self.var_pid.get(),))
                        con.commit()
